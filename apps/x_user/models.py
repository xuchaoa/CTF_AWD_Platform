...
class User_Profile(AbstractUser):
    ...
    user_phone = models.CharField(max_length=11, null=True, blank=False,unique=True, verbose_name="手机")
    user_number = models.CharField(max_length=11,null=True,blank=False,unique=True,verbose_name='学号')
    user_email = models.CharField(max_length=30,null=True,blank=False,unique=True,verbose_name='邮箱')
